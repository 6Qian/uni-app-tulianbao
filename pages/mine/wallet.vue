	...
	<view class="content">
		...
		<view class="top">
			...
			<view class="text">
				...
				<!-- <view @click="withdraw" style="border-radius: 30rpx;padding: 10rpx;background-color: #6125ea;font-size: 20rpx;width:80rpx;text-align: center;margin-left: 20rpx;color: white;">积分兑换</view> -->
				<image @click="withdraw" src="/static/dh.png" mode="" style="width:120rpx; height: 50rpx; margin-left: 20rpx;"></image>
			</view>
			<!-- <view class="hoow" @click="ToGiveaway()" v-if="modelsp">去赠送</view> -->
			<image class="hoow" v-if="modelsp" style="padding: 0; width: 164rpx; height: 63rpx;" @click="ToGiveaway()" src="/static/zs.png" mode=""></image>
		...
		<view class="center">
			...
			<view class="mdlist">
				<view class="lis">
					<view class="icon">
						<image src="../../static/tuiguang.png" mode="aspectFill"></image>
					</view>
					<view class="ttt">推广游戏</view>
				</view>
				<view class="lis">
					<view class="icon">
						<image src="../../static/down.png" mode="aspectFill"></image>
					</view>
					<view class="ttt">下载游戏</view>
				</view>
			</view>
		</view>
...
<style>
	...
	.headerws{
		background: url(../../static/nsncs.png) no-repeat;
		background-size: 100% ;
	}
	.topbg {
		width: 100%;
	...
	.top .title .icon1 {
		width: 32rpx;
		height: 32rpx;
		background: url(../../static/cncs.png) no-repeat;
		background-size: 100% 100%;
		border-radius: 24rpx;
	}
